...
class PaginaBienvenidaWidget extends StatefulWidget {
  const PaginaBienvenidaWidget({super.key});

  static String routeName = 'PaginaBienvenida';
  static String routePath = '/paginaBienvenida';

  @override
  State<PaginaBienvenidaWidget> createState() => _PaginaBienvenidaWidgetState();
}

class _PaginaBienvenidaWidgetState extends State<PaginaBienvenidaWidget> {
  late PaginaBienvenidaModel _model;
