...
import 'text_field_busqueda_model.dart';
export 'text_field_busqueda_model.dart';

class TextFieldBusquedaWidget extends StatefulWidget {
  const TextFieldBusquedaWidget({
    super.key,
    String? helper,
    bool? helperPresent,
    this.leadingIcon,
    ...
    required this.alCambiarTexto,
        ...
        this.hint = hint ?? 'ejemplo@correo.com',
        this.value = value ?? '',
  ...
  final bool error;
  final Future Function(String texto)? alCambiarTexto;

  @override
  State<TextFieldBusquedaWidget> createState() =>
      _TextFieldBusquedaWidgetState();
}

class _TextFieldBusquedaWidgetState extends State<TextFieldBusquedaWidget> {
  late TextFieldBusquedaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TextFieldBusquedaModel());
                  ...
                  Expanded(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (_) => EasyDebounce.debounce(
                        ...
                        () async {
                          await widget.alCambiarTexto?.call(
