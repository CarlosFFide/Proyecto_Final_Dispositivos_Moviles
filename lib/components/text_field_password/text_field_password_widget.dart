...
import 'text_field_password_model.dart';
export 'text_field_password_model.dart';
...
class _TextFieldPasswordWidgetState extends State<TextFieldPasswordWidget> {
  late TextFieldPasswordModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TextFieldPasswordModel());
